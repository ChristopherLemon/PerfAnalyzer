...
from ProcessView.ProcessModel import ProcessModel
...
ProcessView = Blueprint(
    "ProcessView", __name__, template_folder="templates", static_folder="static"
)
        ...
        if job_id == GlobalData.hpc_results[i].get_job_id():
            ...
            if get_source_table:
                source_code_table, source_code_line = generate_source_code_table(
                    all_stack_data[process_model.process],
                    process_id,
                    symbol,
